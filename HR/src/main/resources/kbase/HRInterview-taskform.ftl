...
<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					myInputs[i] = document.getElementById("out_mail");
					i++;
		...
		var j=0;
					...
					j++;
						...
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid out_mail");
							myInputs[j].focus();
							return false;
						}	
					j++;
...
<div id="container">
	<div id="header">
		User Task Form: Hiring a Developer.HRInterview
	</div>
	<div id="content">
		<fieldset>
          ...
          <fieldset>
            ...
            <form action="complete" method="POST" enctype="multipart/form-data" onsubmit="return taskFormValidator()">
                            		...
                            		<div class="div_texbox">
                              		<input name="out_name" type="text" class="textbox" id="out_name" value="" />
                            		</div>	
                            
                            		<label for="name">out_age</label>
                            		<div class="div_texbox">
                              		<input name="out_age" type="text" class="textbox" id="out_age" value="" />
                            		</div>	
                            
                            		<label for="name">out_mail</label>
                            		<div class="div_texbox">
                              		<input name="out_mail" type="text" class="textbox" id="out_mail" value="" />
                            		</div>	
